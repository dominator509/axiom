...
import { linkbioAnalyticsRouter } from './routes/linkbio-analytics.js';
import { fansRouter } from './routes/fans.js';
import { analyticsRouter } from './routes/analytics.js';
import { earningsRouter } from './routes/earnings.js';
import { fanvueAnalyticsRouter } from './routes/fanvue-analytics.js';
import { fanvueLifecycleRouter } from './routes/fanvue-lifecycle.js';
import { commentModerationRouter } from './routes/comment-moderation.js';
import { inboxRouter } from './routes/inbox.js';
import { inboxRepliesRouter } from './routes/inbox-replies.js';
import { inboxReviewsRouter } from './routes/inbox-reviews.js';
...
import { snapchatAuthRouter } from './routes/snapchat-auth.js';
import { socialOAuthRouter } from './routes/social-oauth.js';
...
import { relayCardsRouter } from './routes/relay-cards.js';
...
import { platformBillingWebhookRouter } from './routes/platform-billing-webhook.js';
...
app.use('/api/v1/members/*', requireAuth);
...
app.use('/api/v1/models/:modelId/social-accounts/*', requireAuth);
...
app.use('/api/v1/models/:modelId/watermark-policy', requireAuth);
...
app.use('/api/v1/connectors/:platform/authorize', requireAuth);
app.use('/api/v1/connectors/:platform/refresh', requireAuth);
app.use('/api/v1/connectors/telegram/manual', requireAuth);
app.use('/api/v1/connectors/discord/manual', requireAuth);
app.use('/api/v1/connectors/snapchat/authorize', requireAuth);
app.use('/api/v1/connectors/snapchat/manual', requireAuth);
app.use('/api/v1/connectors/patreon/authorize', requireAuth);
...
app.use('/api/v1/models/*', operationalMutation);
app.use('/api/v1/models/:modelId/social-accounts/*', operationalMutation);
...
app.use('/api/v1/models/:modelId/watermark-policy', operationalMutation);
...
app.use('/api/v1/models/:modelId/viral/pattern-sharing', operationalMutation);
...
app.use('/api/v1/connectors/snapchat/*', operationalMutation);
app.use('/api/v1/connectors/:platform/callback', operationalMutation);
app.use('/api/v1/connectors/:platform/refresh', operationalMutation);
...
app.use('/api/v1/models/:modelId/moderation/rules', idempotency());
app.use('/api/v1/models/:modelId/moderation/rules/:ruleId', idempotency());
app.use('/api/v1/models/:modelId/moderation/scan', idempotency());
app.use('/api/v1/models/:modelId/fanvue/churn-rescues/:rescueId/send', operationalMutation);
app.use('/api/v1/models/:modelId/fanvue/churn-rescues/:rescueId/send', idempotency());
...
app.use('/api/v1/models/:modelId/inbox/replies/:replyId/cancel', idempotency());
app.use('/api/v1/models/:modelId/inbox/replies/:replyId/reviews', idempotency());
app.use('/api/v1/models/:modelId/member-assignments', idempotency());
app.use('/api/v1/members/:userId/role', idempotency());
...
app.use('/api/v1/models/:modelId/watermark-policy', idempotency());
app.use('/api/v1/models/:modelId/roleplay/*', idempotency());
app.use('/api/v1/models/:modelId/viral/insight', idempotency());
app.use('/api/v1/models/:modelId/viral/pattern-sharing', idempotency());
...
app.use('/api/v1/connectors/:platform/refresh', idempotency());
app.use('/api/v1/connectors/snapchat/manual', idempotency());
...
app.route('/api/v1', linkbioAnalyticsRouter);
app.route('/api/v1', fansRouter);
app.route('/api/v1', analyticsRouter);
app.route('/api/v1', earningsRouter);
app.route('/api/v1', fanvueAnalyticsRouter);
app.route('/api/v1', fanvueLifecycleRouter);
app.route('/api/v1', commentModerationRouter);
app.route('/api/v1', inboxRouter);
app.route('/api/v1', inboxRepliesRouter);
app.route('/api/v1', inboxReviewsRouter);
app.route('/api/v1', membersRouter);
...
app.route('/api/v1', relayCardsRouter);
...
app.route('/api/v1/platform', platformBillingWebhookRouter);
