/** Maximum JSON body size accepted by relay API routes. */
export const RELAY_JSON_MAX_BODY_BYTES = 256 * 1024;
...
/** Read a request body incrementally so chunked requests cannot bypass the limit. */
export async function readBoundedText(
  request: Request,
  maxBytes = RELAY_JSON_MAX_BODY_BYTES,
): Promise<string> {
