...
export type MetricName = 'impressions' | 'reach' | 'likes' | 'comments' | 'shares' | 'saves' | 'follows' | 'views' | 'watch_time' | 'engagement_rate' | 'clicks' | 'reposts' | 'quotes' | 'mentions' | 'favorites' | 'retweets';
