...
export { register, connectorFor, hasConnector, allConnectors, registeredPlatforms, resolveCapabilities, validateForPlatform, } from './registry.js';
export { validatePublish } from './validation.js';
export type { ValidationReport } from './types.js';
export type { SocialConnector, ConnectorAuth, ConnectorPublishInput, ConnectorPublishResult, ConnectorCapability, ConnectorMetrics, MetricPeriod, RelayHandoff, IdempotencyEntry, MediaType, MetricName, TosVerdict, } from './types.js';
