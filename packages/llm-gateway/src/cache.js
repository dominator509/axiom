 ...
 */
export function cacheKey(modelId, platform, prefixVersion, segmentHash) {
...
export class PrefixCache {
     ...
     */
    set(key, prefix, modelId, platform, prefixVersion, segmentHash, ttl) {
     ...
     */
    invalidateByModelAndPlatform(modelId, platform) {
        let count = 0;
