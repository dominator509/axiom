...
export default function TeamOperationsManager({ modelId, members, shifts, notes, agentPermissions, canEdit }: { modelId: string; members: TeamMember[]; shifts: TeamShift[]; notes: TeamNote[]; agentPermissions: TeamAgentPermission[]; canEdit: boolean }) {
