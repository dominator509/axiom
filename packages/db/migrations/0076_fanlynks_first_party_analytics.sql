...
ALTER TABLE linkbio_provider
  ...
  ADD COLUMN IF NOT EXISTS fanlynks_analytics_status TEXT NOT NULL DEFAULT 'configured',
...
ALTER TABLE linkbio_provider
  ADD CONSTRAINT linkbio_provider_fanlynks_analytics_status_check
    CHECK (fanlynks_analytics_status IN ('configured', 'connected', 'sync_error')) NOT VALID;
