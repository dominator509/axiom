...
import { Tier, tierAtLeast, createCapabilityToken, validateToken, revokeToken, authenticateAgent, resolveHighestTier, TierResolution, } from './auth.js';
...
describe('authenticateAgent', () => {
    ...
    it('does not accept an authorization header without the Bearer prefix', () => {
        ...
        expect(() => authenticateAgent({ headers: { authorization: `Basic ${token}` } })).toThrow('Authentication required: no token provided');
    });
