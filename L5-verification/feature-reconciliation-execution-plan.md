...
- Still required: separately authorized dispatch with fresh safety/assignment checks, SFW policy handling, uncertain-delivery reconciliation and send controls, attachment handling and authenticated deployed acceptance. Pending intent creation is not message delivery.
