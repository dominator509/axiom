...
- Still required: separately authorized dispatch with fresh safety/assignment checks, SFW policy handling, uncertain-outcome reconciliation, composer/status GUI, attachment handling and authenticated deployed acceptance. Pending intent creation is not message delivery.
