...
- Still required: provider wiring with model egress and a fresh pre-send dispatch fence, uncertain-delivery reconciliation and send controls, attachment handling and authenticated deployed acceptance. Pending intent creation is not message delivery.
