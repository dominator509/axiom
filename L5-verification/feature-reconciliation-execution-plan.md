...
- Still required: uncertain-delivery review API/GUI, attachment handling, agentic drafting, role activation and authenticated deployed acceptance. Pending intent creation is not message delivery.
