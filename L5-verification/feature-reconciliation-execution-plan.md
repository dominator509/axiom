...
- Still required: authenticated HTTP dispatch and send controls, uncertain-delivery reconciliation, attachment handling and authenticated deployed acceptance. Pending intent creation is not message delivery.
