...
| Relay and operator controls (F-68–F-72) | Cards, signed/replay-protected command paths and several approval/revision/review workflows exist. | Attachment sending, external delivery, uncertain-outcome reconciliation and deployed channel acceptance. |
