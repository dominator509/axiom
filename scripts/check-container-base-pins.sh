...
status=0
for dockerfile in infra/Dockerfile.hono infra/Dockerfile.next infra/Dockerfile.rust infra/Dockerfile.media infra/Dockerfile.vision infra/Dockerfile.scraper infra/Dockerfile.worker; do
