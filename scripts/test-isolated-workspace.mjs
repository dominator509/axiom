...
const focused = focusedWorker || focusedVariants;
...
try {
  ...
  const testFile = focusedVariants ? 'packages/api/src/routes/variant-performance.integration.test.ts' : 'packages/worker/src/worker-media.integration.test.ts';
