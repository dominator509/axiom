...
NEXT_ACTION: `Codex audits the remaining architecture reconciliation gaps, selects one finite gate, and binds any future Hermes task to the newly read source head; no stale lane resumes.`
