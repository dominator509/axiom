...
SOURCE_HEAD: `c6b5996a295a307c553657aa8f9c819b669a4454` (exact remote source after M839 model overview localization)
PUBLISHED_BRANCH: `codex/telegram-webhook-hardening`
PUBLISHED_HEAD: `c6b5996a295a307c553657aa8f9c819b669a4454` (M839 source-bearing ref read back from origin)
COORDINATION_HEAD: `c6b5996a295a307c553657aa8f9c819b669a4454` (M839 source-bearing ref read back before this handoff-only update)
ACCEPTED_PRODUCT_SOURCE: `c6b5996a295a307c553657aa8f9c819b669a4454`
ACTIVE_HERMES_LANE: `CLOSED_SUPERSEDED_LOCAL_FALLBACK — no Hermes implementation lane is active; M839 was completed and audited locally`
CODEX_OWNER: `CODEX`
...
NEXT_ACTION: `Do not resume any superseded lane. Reconcile M839 against the architecture table, then select one new finite architecture gap; no stale Hermes lane may resume.`
...
OPEN_CONTROL_TASK_NEXT_ACTION: `No action for the superseded wire. Future Hermes work must use a new exact-source task selected after M839 reconciliation; no ACK loop or stale delivery is accepted`
ACTIVE_LANE_LOCAL_BASELINE: `M786 F84 versioned learning arms, M787 scraper route-shell localization, M789 workspace-members route-shell localization, M791 Grok connection route-shell localization, M793 cascades route-shell localization, M795 team/shifts route-shell localization, M797 variant-experiments route-shell localization, M799 portfolio home-shell localization, M806 media gallery shell localization, M815/M818 media approval localization, M820 generation/upload/progress localization, M822 caption evidence localization, M824 Patreon web localization, M833 Relay reconciliation, M837 variant source ownership hardening, M838 temporal guidance arm/consumer hardening, and M839 model overview route-shell localization are integrated on the branch. M839 criterion: the model overview's visible labels, network states, action links and UTC date are catalog-backed across all six launch locales; Spanish route-shell behavior test passes; no live action.`
...
LAST_COMPLETED_SOURCE_MILESTONE: `M839 — model overview route-shell localization at c6b5996`
...
RECONCILIATION_STATE: `CONTROL_PROTOCOL_CANONICAL; stale lanes remain superseded; M833 relay, M837 variant ownership hardening, M838 temporal guidance and M839 model overview localization are implemented, tested and pushed; no Hermes product lane is active; no live action`
...
SHIP_GATE_HEAD: `c6b5996a295a307c553657aa8f9c819b669a4454` (M839 source evidence refreshed; scripts/verify.sh returned verify: ok; full root test matrix still has four unrelated Windows llm-gateway process-tree failures)
...
CURRENT_MILESTONE: `M839 — model overview route-shell localization integrated and pushed`
CURRENT_MILESTONE_COMMIT: `c6b5996a295a307c553657aa8f9c819b669a4454`
CURRENT_MILESTONE_EVIDENCE_CANONICAL: `Core locale/settings 40/40; model overview dashboard tests 14/14 including persisted Spanish locale; core build/typecheck/lint pass; dashboard typecheck/lint pass with four pre-existing any warnings; scripts/verify.sh prints verify: ok; remote branch read back at c6b5996; LIVE_ACTIONS NONE`
CURRENT_MILESTONE_OPEN_CANONICAL: `The M839 source slice is closed: the model overview route now resolves the persisted UI locale, localizes profile/network/activity/workspace-tool copy across all six launch locales, suppresses raw network-error text and formats created-at in UTC through the shared server resolver. F89 remains open for remaining dashboard/email/operator adoption, every date/number/currency formatting surface, browser/native acceptance and deployed migration/RLS/runtime evidence; all other architecture and live/provider gates remain open; no production readiness claim is made.`
CURRENT_MILESTONE_REMOTE_READBACK_ACTIVE_CANONICAL: `c6b5996a295a307c553657aa8f9c819b669a4454 is the exact M839 product source read back from origin; the previous temporal Hermes lane remains terminally superseded; no Hermes artifact was accepted and no live action occurred.`
...
CURRENT_MILESTONE_EVIDENCE: `M839 source changes are in c6b5996 and remote-read-back; focused route and locale gates passed; no Hermes artifact is counted; no live action.`
CURRENT_MILESTONE_OPEN: `Reconcile M839 against the architecture table, then open exactly one new finite gap. Hermes must receive a new exact-source task only after that selection; no stale wire may resume.`
