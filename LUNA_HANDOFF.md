...
SOURCE_HEAD: `78809a3ca102b218dfe616e36372896de9ef08bc` (exact remote source after M844 InboxReplies localization)
PUBLISHED_BRANCH: `codex/telegram-webhook-hardening`
PUBLISHED_HEAD: `78809a3ca102b218dfe616e36372896de9ef08bc` (M844 source-bearing ref read back from origin)
COORDINATION_HEAD: `78809a3ca102b218dfe616e36372896de9ef08bc` (M844 source-bearing ref read back before this handoff-only update)
ACCEPTED_PRODUCT_SOURCE: `78809a3ca102b218dfe616e36372896de9ef08bc`
...
NEXT_ACTION: `M844 is closed. Reconcile it against the architecture table, then select one new finite architecture gap; open a fresh Hermes lane only after exact-source selection and branch readback. No stale Hermes lane may resume.`
...
LAST_COMPLETED_SOURCE_MILESTONE: `M844 — InboxReplies/Chatter localization at 78809a3`
...
SHIP_GATE_HEAD: `78809a3ca102b218dfe616e36372896de9ef08bc` (M844 source evidence refreshed; scripts/verify.sh returned verify: ok; full dashboard matrix passed; no live action)
...
CURRENT_MILESTONE: `M844 — InboxReplies/Chatter localization integrated and pushed`
CURRENT_MILESTONE_COMMIT: `78809a3ca102b218dfe616e36372896de9ef08bc`
CURRENT_MILESTONE_EVIDENCE_CANONICAL: `InboxReplies behavior/locale tests 13/13; full dashboard matrix 140 files and 861 tests passed; core locale tests 57/57; core/dashboard typechecks pass; core/dashboard lint exits 0 with four pre-existing any warnings; dashboard production build compile/lint/type/page generation/trace passed; scripts/verify.sh prints verify: ok; remote branch read back at 78809a; LIVE_ACTIONS NONE`
CURRENT_MILESTONE_OPEN_CANONICAL: `The M844 source slice is closed: Chatter InboxReplies history, assigned-LLM draft, human approval, send/cancel, status/outcome, retry, character-count and UTC time strings now use the shared six-locale catalog. Assigned-LLM drafts remain private and human-reviewed; no automatic send behavior changed. F89 remains open for remaining dashboard/email/operator catalog adoption, every date/number/currency formatting surface, browser/native acceptance and deployed migration/RLS/runtime evidence; all other architecture and live/provider gates remain open; no production readiness claim is made.`
CURRENT_MILESTONE_REMOTE_READBACK_ACTIVE_CANONICAL: `78809a3ca102b218dfe616e36372896de9ef08bc is the exact M844 product source read back from origin; no Hermes artifact was accepted, no Hermes implementation lane is active, and no live action occurred.`
...
CURRENT_MILESTONE_EVIDENCE: `M844 source changes are in 78809a3 and remote-read-back; focused InboxReplies, core locale, full-dashboard and production-build gates passed; no Hermes artifact is counted; no live action.`
CURRENT_MILESTONE_OPEN: `Reconcile M844 against the architecture table, then open exactly one new finite gap. Hermes must receive a new exact-source task only after that selection; no stale wire may resume.`
