...
SOURCE_HEAD: `1a0d82800e2cffd4fd919ffbf971df2f1abf9c62` (current pushed source pin for the active F33 R3 lane; Hermes must not infer a newer source)
PUBLISHED_BRANCH: `codex/telegram-webhook-hardening`
PUBLISHED_HEAD: `725c0d94` (last verified origin head used to re-pin the active Hermes task; exact implementation source remains 1a0d8280)
COORDINATION_HEAD: `725c0d94`
COORDINATION_HEAD_LAST_READBACK: `725c0d94 — handoff reconciliation pushed; updated F33 R3 task and marker hashes read back; no Hermes ACK or source copy has been observed yet`
ACCEPTED_PRODUCT_SOURCE: `6844f8ef6e266660f5d6a71d9c9acdecdc29a59b`
CURRENT_TASK_MANIFEST: `var/hermes-control/current-task.json — OPEN marker for F33-PROVIDER-CACHE-CONTROLS-SOURCE-R3; remote marker mirrors this task`
CURRENT_TASK_MANIFEST_SHA256: `74c1c1865beb8f5f799aa118de55e65d711acbdae481490ad8fd1613de94b88d`
CURRENT_TASK_MANIFEST_REMOTE_SHA256: `74c1c1865beb8f5f799aa118de55e65d711acbdae481490ad8fd1613de94b88d — next Hermes wire must confirm manifesto read and exact source/task binding`
...
LAST_COMPLETED_SOURCE_MILESTONE: `M931 — model-scoped viral insight Relay cards committed and pushed at 90a85530d2ab56e3c5811e162a80ae31783c1e3f; F85 was superseded without an integrated delivery`
ACTIVE_HERMES_LANE: `F33-PROVIDER-CACHE-CONTROLS-SOURCE-R3 — source-only lane; Hermes has not yet returned the required strict ACK or created the exact source copy`
CODEX_OWNER: `CODEX`
...
NEXT_ACTION: `Hermes must read HERMES_MANIFESTO.md, AGENTS.md, COMMANDS.md, LUNA_HANDOFF.md and the protocol, fetch all refs, verify the exact source/task hashes and ancestry, and return one strict ACK with STATE READ or ACCEPTED before coding. Hermes then works only in the exact R3 COPY_ROOT and returns real PROGRESS followed by strict DELIVERY or terminal BLOCKED; Hermes never commits or pushes. Codex waits through at least five spaced read-only polls before judging the lane, then audits and integrates only verified source. No deployment, installer, live migration, provider, credential, permission, systemd, network or runtime action.`
BRIDGE_OBSERVATION: `F33 R2 was terminally rejected after independent audit: its mapper had no non-test production callsite and migration 0062 granted an undefined axiom role. F33 R3 is the only active lane; the marker/task are published and read back, but Hermes has not yet ACKed or started a source copy. All older inbox/reply/status/outbox/worktree identities remain inert regardless of transport order.`
CURRENT_LOCAL_DELIVERY: `M931 — model-scoped viral insight Relay cards; commit 90a85530d2ab56e3c5811e162a80ae31783c1e3f; DB/core/worker/API/dashboard source wiring and focused gates pass`
PRODUCT_COMPLETION_COMMIT: `90a85530d2ab56e3c5811e162a80ae31783c1e3f — M931 model-scoped viral insight Relay cards`
HERMES_LANE_DISPOSITION: `F33 R2 CLOSED — Codex independently rejected the terminal delivery and published a READ receipt; F33 R3 is OPEN with no source accepted or integrated until Hermes returns the manifesto-confirmed ACK and a valid delivery`
...
OPEN_WIRES: `CODEX-F33-PROVIDER-CACHE-CONTROLS-SOURCE-R2-TASK-001 — awaiting Hermes strict ACK correction after CODEX-F33-PROVIDER-CACHE-CONTROLS-R2-ACK-REJECT-002`
...
CURRENT_MILESTONE: `F33 R3 task/marker published from source pin 1a0d82800e2cffd4fd919ffbf971df2f1abf9c62 with ref head 725c0d94; task SHA 934b4c4e503a708131a29560db91220e195a4a1ed4f0b7d51fb911e4cc63c5cd and marker SHA 74c1c1865beb8f5f799aa118de55e65d711acbdae481490ad8fd1613de94b88d read back; Hermes ACK/source copy still pending; no live action`
CURRENT_MILESTONE_OPEN_GATES: `F33 R3 manifesto confirmation, strict ACK, source delivery, Codex audit and integration remain open; M931 migration application, deployed worker/runtime acceptance, automatic scheduling, provider delivery, revenue/conversion attribution and full contextual-arm semantics remain open; F50 Linktree remains terminally deferred for missing provider contract; browser/mobile, RLS, observability, CI/branch-protection, WireGuard and production/operator acceptance remain open.`
