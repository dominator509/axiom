...
OPEN_CONTROL_TASK_STATE: `OPEN — awaiting one correlated ACK or NACK; no implementation is counted until ACCEPTED`
...
OPEN_CONTROL_TASK_NEXT_ACTION: `Hermes must verify c56243f and writable COPY_ROOT, then publish PROGRESS or terminal BLOCKED; Codex must not infer ownership from transport REPLIED`
...
CURRENT_MILESTONE: `M826 coordination — F-85 Relay reconciliation source lane dispatched against M824 exact source; implementation not yet accepted`
CURRENT_MILESTONE_COMMIT: `c56243fff44d87349ebbe5d3b5ba64586cb3e794`
CURRENT_MILESTONE_EVIDENCE_CANONICAL: `Task envelope protocol-check PASS; local and remote envelope SHA-256 f30ab9e3... match; Hermes checkout was read as stale 7c4a945, so the task requires exact c56243f source synchronization before any edit; LIVE_ACTIONS NONE`
CURRENT_MILESTONE_OPEN_CANONICAL: `Await correlated ACK/NACK, exact-source precheck, evidence-bearing PROGRESS and terminal DELIVERY/BLOCKED. Browser/native, deployed media/R2/runtime, provider OAuth/webhook, migration/RLS, observability, CI governance and other operator gates remain open; no production readiness claim is made.`
