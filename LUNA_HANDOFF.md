...
SOURCE_HEAD: `05b6fc5c03ea304998a47080da1778eb9bcb4a84` (exact remote source after M846 affiliate hold-date localization)
PUBLISHED_BRANCH: `codex/telegram-webhook-hardening`
PUBLISHED_HEAD: `05b6fc5c03ea304998a47080da1778eb9bcb4a84` (M846 source-bearing ref read back from origin)
COORDINATION_HEAD: `05b6fc5c03ea304998a47080da1778eb9bcb4a84` (M846 source-bearing ref read back before this handoff-only update)
ACCEPTED_PRODUCT_SOURCE: `05b6fc5c03ea304998a47080da1778eb9bcb4a84`
...
NEXT_ACTION: `M846 is closed. Reconcile it against the architecture table, then select one new finite architecture gap; open a fresh Hermes lane only after exact-source selection and branch readback. No stale Hermes lane may resume.`
...
LAST_COMPLETED_SOURCE_MILESTONE: `M846 — affiliate hold-date localization at 05b6fc5`
CURRENT_PRODUCT_BASELINE: `M846 is the latest reviewed source baseline: the mounted platform affiliate manager formats open-hold dates with the selected locale and explicit UTC; the focused regression, full dashboard tests, build, lint, typecheck and verify gates passed; no Hermes implementation lane or live action is active.`
...
SHIP_GATE_HEAD: `05b6fc5c03ea304998a47080da1778eb9bcb4a84` (M846 source evidence refreshed; scripts/verify.sh returned verify: ok; full dashboard matrix passed; no live action)
...
CURRENT_MILESTONE: `M846 — affiliate hold-date localization integrated and pushed`
CURRENT_MILESTONE_COMMIT: `05b6fc5c03ea304998a47080da1778eb9bcb4a84`
CURRENT_MILESTONE_EVIDENCE_CANONICAL: `PlatformAffiliateManager focused tests 3/3 including host-timezone regression; full dashboard matrix 141 files and 863 tests passed; dashboard typecheck passes; dashboard lint exits 0 with four pre-existing any warnings; dashboard production build compile/lint/type/page generation/trace passed; scripts/verify.sh prints verify: ok; remote branch read back at 05b6fc5; LIVE_ACTIONS NONE`
CURRENT_MILESTONE_OPEN_CANONICAL: `The M846 source slice is closed: open affiliate holds now render selected-locale medium dates in explicit UTC, while affiliate API, mutation, payout, and hold-resolution semantics remain unchanged. F89 remains open for remaining dashboard/email/operator catalog adoption and other date/number/currency surfaces, browser/native acceptance and deployed migration/RLS/runtime evidence; all other architecture and live/provider gates remain open; no production readiness claim is made.`
CURRENT_MILESTONE_REMOTE_READBACK_ACTIVE_CANONICAL: `05b6fc5c03ea304998a47080da1778eb9bcb4a84 is the exact M846 product source read back from origin; no Hermes artifact was accepted, no Hermes implementation lane is active, and no live action occurred.`
...
CURRENT_MILESTONE_EVIDENCE: `M846 source changes are in 05b6fc5 and remote-read-back; focused affiliate-manager regression, full-dashboard and production-build gates passed; no Hermes artifact is counted; no live action.`
CURRENT_MILESTONE_OPEN: `Reconcile M846 against the architecture table, then open exactly one new finite gap. Hermes must receive a new exact-source task only after that selection; no stale wire may resume.`
