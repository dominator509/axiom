...
SOURCE_HEAD: `95e2eb3fdd553f896e7006bb990303813bc54772` (exact remote source after M847 affiliate hold-reason localization)
PUBLISHED_BRANCH: `codex/telegram-webhook-hardening`
PUBLISHED_HEAD: `95e2eb3fdd553f896e7006bb990303813bc54772` (M847 source-bearing ref read back from origin)
COORDINATION_HEAD: `95e2eb3fdd553f896e7006bb990303813bc54772` (M847 source-bearing ref read back before this handoff-only update)
ACCEPTED_PRODUCT_SOURCE: `95e2eb3fdd553f896e7006bb990303813bc54772`
ACTIVE_HERMES_LANE: `CLOSED — no Hermes implementation lane is active; M847 was completed and audited locally`
CODEX_OWNER: `CODEX`
...
NEXT_ACTION: `M847 is closed. Reconcile it against the architecture table, then select one new finite architecture gap; open a fresh Hermes lane only after exact-source selection and branch readback. No stale Hermes lane may resume.`
...
LAST_COMPLETED_SOURCE_MILESTONE: `M847 — affiliate hold-reason localization at 95e2eb3`
CURRENT_PRODUCT_BASELINE: `M847 is the latest reviewed source baseline: the mounted platform affiliate manager renders known persisted hold reason codes through the six-locale affiliate catalog with a safe unknown-value fallback; the focused regression, full dashboard tests, build, lint, typecheck and verify gates passed; no Hermes implementation lane or live action is active.`
...
SHIP_GATE_HEAD: `95e2eb3fdd553f896e7006bb990303813bc54772` (M847 source evidence refreshed; scripts/verify.sh returned verify: ok; full dashboard matrix passed; no live action)
...
CURRENT_MILESTONE: `M847 — affiliate hold-reason localization integrated and pushed`
CURRENT_MILESTONE_COMMIT: `95e2eb3fdd553f896e7006bb990303813bc54772`
CURRENT_MILESTONE_EVIDENCE_CANONICAL: `Platform affiliate catalog completeness 1/1; PlatformAffiliateManager focused tests 4/4 including UTC and hold-reason regressions; full dashboard matrix 141 files and 864 tests passed; dashboard typecheck passes; dashboard lint exits 0 with four pre-existing any warnings; dashboard production build compile/lint/type/page generation/trace passed; scripts/verify.sh prints verify: ok; remote branch read back at 95e2eb3; LIVE_ACTIONS NONE`
CURRENT_MILESTONE_OPEN_CANONICAL: `The M847 source slice is closed: known persisted affiliate hold reason codes now render through a six-locale feature catalog with a safe fallback for unknown values, while affiliate API, mutation, payout, and hold-resolution semantics remain unchanged. F89 remains open for remaining dashboard/email/operator catalog adoption and other date/number/currency surfaces, browser/native acceptance and deployed migration/RLS/runtime evidence; all other architecture and live/provider gates remain open; no production readiness claim is made.`
CURRENT_MILESTONE_REMOTE_READBACK_ACTIVE_CANONICAL: `95e2eb3fdd553f896e7006bb990303813bc54772 is the exact M847 product source read back from origin; no Hermes artifact was accepted, no Hermes implementation lane is active, and no live action occurred.`
...
CURRENT_MILESTONE_EVIDENCE: `M847 source changes are in 95e2eb3 and remote-read-back; affiliate catalog completeness, focused affiliate-manager regression, full-dashboard and production-build gates passed; no Hermes artifact is counted; no live action.`
CURRENT_MILESTONE_OPEN: `Reconcile M847 against the architecture table, then open exactly one new finite gap. Hermes must receive a new exact-source task only after that selection; no stale wire may resume.`
