...
ACTIVE_HERMES_LANE: `F89-DRAFT-EDITOR-LOCALIZATION-R3 — execution-authorized superseding task uses the verified Git bundle and writable copy path; Hermes must implement immediately after exact source verification`
CODEX_OWNER: `CODEX`
...
NEXT_ACTION: `Require concrete PROGRESS after exact source verification, followed by one DELIVERY or terminal BLOCKED; no intake ACK is required and no duplicate lane may open.`
CONTROL_PROTOCOL: `FT-HERMES/1 ACK-NACK-1`
CONTROL_PROTOCOL_SOURCE: `L5-verification/hermes-message-protocol.md`
OPEN_WIRES: `CODEX-F89-DRAFT-EDITOR-LOCALIZATION-R3-001 — only active product wire; R1/R2 transport artifacts are superseded; historical F89 PlaybookHistory remains closed`
...
NEXT_PREPARED_TASK_STATE: `SENT — implementation authorized after exact verification; awaiting PROGRESS or terminal BLOCKED`
ACTIVE_LANE_TASK_WIRE: `CODEX-F89-DRAFT-EDITOR-LOCALIZATION-R3-001`
...
ACTIVE_LANE_COPY_STATE: `EXECUTION_AUTHORIZED — exact Git bundle and commit are verified; awaiting concrete source/test delta`
...
ACTIVE_LANE_CORRECTION_ENVELOPE_SHA256: `NOT_APPLICABLE — fresh execution-authorized task`
...
CURRENT_MILESTONE_EVIDENCE: `F89 R3 is a fresh execution-authorized source-only lane after the R2 ACK loop; the exact Git bundle and a3f74fef commit are already verified, the writable copy root is reachable, and no intake ACK is required; M757/M759/M761/M763 close AgentPermissionManager, TriggerRuleManager, ApproveButtons and MediaBundleCreate operator criteria with focused evidence 47/47; core build/tests, dashboard typecheck/lint and diff-check passed; no Hermes artifact was accepted`
CURRENT_MILESTONE_OPEN: `F89-DRAFT-EDITOR-LOCALIZATION-R3 is awaiting concrete PROGRESS or terminal BLOCKED; after its terminal outcome close the next finite approval-child or Audit criterion; remaining dashboard/email adoption, browser/mobile, provider, migration/RLS, runtime, external storage, deployment and operator gates remain open`
