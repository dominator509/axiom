...
SOURCE_HEAD: `50a6a101179cdd969cfab7f1e8e0f67dc445042e`
...
OPEN_CONTROL_TASK_STATE: `OPEN — Hermes SEQ 1 reply rejected; corrected SEQ 3 reply pending`
OPEN_CONTROL_TASK_REPLY_WIRE: `HERMES_REPLY_WIRE_PENDING_SEQ3`
OPEN_CONTROL_TASK_RECEIPT_WIRE: `CODEX-CONTROL-PLANE-HERMES-STALE-WORKER-STOP-R1-REJECT-002`
OPEN_CONTROL_TASK_RECEIPT_SHA256: `48cdcde41ac57f9d95bb6053bf5d0cba4aeb3349c071c2f3524b1dbeb2d8f782`
OPEN_CONTROL_TASK_NEXT_ACTION: `Hermes returns one fresh protocol-valid ACK/READ or NACK/BLOCKED at SEQ 3 with a distinct WIRE and exact correlation. Codex then receipts it and opens one bounded product lane; no duplicate task or stale-lane resume.`
...
LOOP_CURRENT_ACTION: `Await Hermes SEQ 3 corrected ACK/READ or NACK/BLOCKED for the exact task wire; receipt it by logical SEQ, then issue exactly one fresh bounded architecture feature TASK against a freshly read branch tip; accept no stale product lane`

CURRENT_MILESTONE: `M734 — rejected malformed Hermes stop reply and issued correlated correction receipt; no product implementation lane active`
...
CURRENT_MILESTONE_OPEN: `Hermes must return a fresh SEQ 3 protocol-valid ACK/READ or NACK/BLOCKED with a distinct WIRE and exact correlation; after Codex receipts the reply, select exactly one finite architecture feature lane; deployment/readiness gates remain separate`
CURRENT_MILESTONE_REMOTE_READBACK_CURRENT: `Stop-control task SHA 87df0e32071072650d1d7075d9a6c77ca2bdc1930e6fff16d091625765c279fa and correction receipt SHA 48cdcde41ac57f9d95bb6053bf5d0cba4aeb3349c071c2f3524b1dbeb2d8f782 verified; corrected SEQ 3 reply pending; no feature or live action`
