...
OPEN_CONTROL_TASK_STATE: `ACCEPTED — exact source verified; Hermes owns implementation; progress-required receipt sent`
...
ACTIVE_LANE_COPY_STATE: `ACCEPTED — exact source verified; Hermes owns implementation; concrete PROGRESS is still required`
...
LOOP_CURRENT_ACTION: `Await the F-89 PlaybookHistory PROGRESS and terminal DELIVERY or BLOCKED after progress-required SEQ 4; accept no second ACK, stale lane, copied baseline or unsupported completion claim`

CURRENT_MILESTONE: `M742 — Hermes accepted lane received one progress-required receipt; implementation evidence remains the next gate`
