...
OPEN_CONTROL_TASK_STATE: `IN_PROGRESS — corrected PROGRESS accepted; Hermes now owns the bounded edit and terminal DELIVERY`
OPEN_CONTROL_TASK_REPLY_WIRE: `HERMES-F89-PLAYBOOK-HISTORY-LOCALIZATION-001-PROGRESS-007`
...
OPEN_CONTROL_TASK_NEXT_ACTION: `Hermes applies the bounded edit and publishes one terminal DELIVERY or BLOCKED with reviewable bytes, six-locale coverage, focused tests, dashboard typecheck, exact exits and per-file hashes; no second ACK or progress restatement.`
...
ACTIVE_LANE_COPY_STATE: `IN_PROGRESS — exact source staged, corrected PROGRESS accepted; Hermes editing only the declared isolated copy`
...
LOOP_CURRENT_ACTION: `Await F-89 PlaybookHistory terminal DELIVERY or BLOCKED after accepted PROGRESS; accept no second ACK, progress restatement, stale lane, copied baseline or unsupported completion claim`

CURRENT_MILESTONE: `M748 — Corrected Hermes PlaybookHistory PROGRESS accepted; terminal DELIVERY or BLOCKED is the next gate`
