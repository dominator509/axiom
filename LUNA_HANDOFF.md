...
SOURCE_HEAD: `18e09a97e5e8252d35c69206657e47f6ce0efe3a` (exact remote source after M843 social-disconnect localization)
PUBLISHED_BRANCH: `codex/telegram-webhook-hardening`
PUBLISHED_HEAD: `18e09a97e5e8252d35c69206657e47f6ce0efe3a` (M843 source-bearing ref read back from origin)
COORDINATION_HEAD: `18e09a97e5e8252d35c69206657e47f6ce0efe3a` (M843 source-bearing ref read back before this handoff-only update)
ACCEPTED_PRODUCT_SOURCE: `18e09a97e5e8252d35c69206657e47f6ce0efe3a`
ACTIVE_HERMES_LANE: `CLOSED — no Hermes implementation lane is active; M843 was completed and audited locally`
CODEX_OWNER: `CODEX`
...
NEXT_ACTION: `M843 is closed. Reconcile it against the architecture table, then select one new finite architecture gap; open a fresh Hermes lane only after exact-source selection and branch readback. No stale Hermes lane may resume.`
...
LAST_COMPLETED_SOURCE_MILESTONE: `M843 — social disconnect localization at 18e09a9`
...
SHIP_GATE_HEAD: `18e09a97e5e8252d35c69206657e47f6ce0efe3a` (M843 source evidence refreshed; scripts/verify.sh returned verify: ok; full dashboard matrix passed; no live action)
...
CURRENT_MILESTONE: `M843 — social disconnect localization integrated and pushed`
CURRENT_MILESTONE_COMMIT: `18e09a97e5e8252d35c69206657e47f6ce0efe3a`
CURRENT_MILESTONE_EVIDENCE_CANONICAL: `DisconnectSocialAccountButton behavior/locale tests 2/2; full dashboard matrix 139 files and 860 tests passed; core locale tests 57/57; core/dashboard typechecks pass; core/dashboard lint exits 0 with four pre-existing any warnings; dashboard production build compile/lint/type/page generation/trace passed; scripts/verify.sh prints verify: ok; remote branch read back at 18e09a; LIVE_ACTIONS NONE`
CURRENT_MILESTONE_OPEN_CANONICAL: `The M843 source slice is closed: disconnect confirmation, provider-revocation rejection/success/retry states and action labels now use the shared six-locale catalog while preserving revocation-before-local-removal and idempotency semantics. F89 remains open for remaining dashboard/email/operator catalog adoption, every date/number/currency formatting surface, browser/native acceptance and deployed migration/RLS/runtime evidence; all other architecture and live/provider gates remain open; no production readiness claim is made.`
CURRENT_MILESTONE_REMOTE_READBACK_ACTIVE_CANONICAL: `18e09a97e5e8252d35c69206657e47f6ce0efe3a is the exact M843 product source read back from origin; no Hermes artifact was accepted, no Hermes implementation lane is active, and no live action occurred.`
...
CURRENT_MILESTONE_EVIDENCE: `M843 source changes are in 18e09a9 and remote-read-back; focused disconnect, core locale, full-dashboard and production-build gates passed; no Hermes artifact is counted; no live action.`
CURRENT_MILESTONE_OPEN: `Reconcile M843 against the architecture table, then open exactly one new finite gap. Hermes must receive a new exact-source task only after that selection; no stale wire may resume.`
