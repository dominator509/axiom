...
ACTIVE_HERMES_LANE: `F89-DRAFT-EDITOR-LOCALIZATION-R2 — fresh superseding task uses the hash-verified Git bundle and a bridge-writable isolated copy path; awaiting one correlated ACK/NACK`
CODEX_OWNER: `CODEX`
...
NEXT_ACTION: `Await the correlated ACK/READ or ACK/ACCEPTED for F89-DRAFT-EDITOR-LOCALIZATION-R2; after acceptance require concrete PROGRESS and one DELIVERY or terminal BLOCKED, with no duplicate lane.`
CONTROL_PROTOCOL: `FT-HERMES/1 ACK-NACK-1`
CONTROL_PROTOCOL_SOURCE: `L5-verification/hermes-message-protocol.md`
OPEN_WIRES: `CODEX-F89-DRAFT-EDITOR-LOCALIZATION-R2-001 — only active product wire; all R1 transport artifacts are superseded; historical F89 PlaybookHistory remains closed`
...
NEXT_PREPARED_TASK_STATE: `SENT — awaiting correlated Hermes ACK/NACK`
ACTIVE_LANE_TASK_WIRE: `CODEX-F89-DRAFT-EDITOR-LOCALIZATION-R2-001`
...
ACTIVE_LANE_COPY_STATE: `AWAITING_ACK — exact Git bundle is readable and hash-verified; no implementation or source delivery accepted`
...
ACTIVE_LANE_CORRECTION_ENVELOPE_SHA256: `NOT_APPLICABLE — fresh superseding task uses a new WIRE`
...
CURRENT_MILESTONE_EVIDENCE: `F89 R1 transport and ACK defects are superseded by a fresh R2 task with a bridge-writable copy root; the exact Git bundle containing a3f74fef is hash-verified and bundle-verified in the bridge inbox; M757/M759/M761/M763 close AgentPermissionManager, TriggerRuleManager, ApproveButtons and MediaBundleCreate operator criteria with focused evidence 47/47; core build/tests, dashboard typecheck/lint and diff-check passed; no Hermes artifact was accepted`
CURRENT_MILESTONE_OPEN: `F89-DRAFT-EDITOR-LOCALIZATION-R2 is awaiting ACK/NACK; after its terminal outcome close the next finite approval-child or Audit criterion; remaining dashboard/email adoption, browser/mobile, provider, migration/RLS, runtime, external storage, deployment and operator gates remain open`
