...
NEXT_ACTION: `send-prepared-INBOX-AGENTIC-DRAFTING-R2-task-after-control-receipt`
CONTROL_PROTOCOL: `FT-HERMES/1 ACK-NACK-1`
CONTROL_PROTOCOL_SOURCE: `L5-verification/hermes-message-protocol.md`
OPEN_WIRES: `NONE — control reconciliation closed; next feature task is prepared but not yet sent`
...
NEXT_PREPARED_TASK: `INBOX-AGENTIC-DRAFTING-R2`
NEXT_PREPARED_TASK_WIRE: `CODEX-INBOX-AGENTIC-DRAFTING-R2-TASK`
...
NEXT_PREPARED_TASK_STATE: `READY LOCALLY; NOT SENT; control reconciliation is closed and this is the sole next feature lane`
